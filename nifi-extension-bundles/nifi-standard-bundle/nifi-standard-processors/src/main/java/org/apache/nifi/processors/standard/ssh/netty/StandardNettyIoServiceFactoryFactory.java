...
/**
 * Standard implementation supporting Proxy Configuration
 */
public class StandardNettyIoServiceFactoryFactory extends AbstractIoServiceFactoryFactory {

    private final ProxyConfiguration proxyConfiguration;

    public StandardNettyIoServiceFactoryFactory(final ProxyConfiguration proxyConfiguration) {
        super(null);
    ...
    public IoServiceFactory create(final FactoryManager manager) {
        ...
        final IoServiceFactory ioServiceFactory = new StandardNettyIoServiceFactory(manager, proxyConfiguration);
