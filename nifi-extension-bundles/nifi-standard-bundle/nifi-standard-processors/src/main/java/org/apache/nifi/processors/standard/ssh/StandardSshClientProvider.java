...
public class StandardSshClientProvider implements SshClientProvider {
    ...
    private void setProxy(final PropertyContext context, final SshClient sshClient) {
        ...
        final Duration connectionTimeout = context.getProperty(CONNECTION_TIMEOUT).asDuration();
        final StandardNettyIoServiceFactoryFactory ioServiceFactoryFactory = new StandardNettyIoServiceFactoryFactory(proxyConfiguration);
